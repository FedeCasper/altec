...
export const sectorGraficoServices: Service[] = [
  ...
  },
  {
    ...
    description: "Lonas de gran formato y banners para fachadas, eventos, stands y locales.",
    whatsappMessage: "Hola, quiero cotizar lonas o banners.",
    icon: "tarp",
    tags: ["lonas", "banners", "gran formato", "fachada", "roll up", "stands", "eventos", "publicidad", "cartel"],
  },
  {
    id: "carteleria",
    name: "Cartelería",
